                ...
                <Row>
                  <InputGroup>
                    ...
                    <input
                      ...
                      onBlur={form.handleBlur}
                      className={
                        ckeckInputHasError('deliveryEmail') ? 'error' : ''
                      }
                    />
                  </InputGroup>
                  <InputGroup>
                    ...
                    <input
                      ...
                      onBlur={form.handleBlur}
                      className={
                        ckeckInputHasError('confirmDeliveryEmail')
                          ? 'error'
                          : ''
                      }
                    />
                      ...
                      <Row>
                        <InputGroup>
                          ...
                          <input
                            ...
                            onBlur={form.handleBlur}
                            className={
                              ckeckInputHasError('cardOwner') ? 'error' : ''
                            }
                          />
                        </InputGroup>
                        <InputGroup>
                          ...
                          <InputMask
                            ...
                            onBlur={form.handleBlur}
                            className={
                              ckeckInputHasError('cpfCardOwner') ? 'error' : ''
                            }
                            mask={'999.999.999-99'}
                          />
                        </InputGroup>
                      ...
                      <Row marginTop="24px">
                        <InputGroup>
                          ...
                          <input
                            ...
                            onBlur={form.handleBlur}
                            className={
                              ckeckInputHasError('cardDispalyName')
                                ? 'error'
                                : ''
                            }
                          />
                        ...
                        <InputGroup>
                          ...
                          <InputMask
                            ...
                            onBlur={form.handleBlur}
                            className={
                              ckeckInputHasError('cardNumber') ? 'error' : ''
                            }
                        ...
                        <InputGroup maxWidth="123px">
                          ...
                          <InputMask
                            ...
                            onBlur={form.handleBlur}
                            className={
                              ckeckInputHasError('expiresMonth') ? 'error' : ''
                            }
                            mask={'99'}
                          />
                        </InputGroup>
                        <InputGroup maxWidth="123px">
                          ...
                          <InputMask
                            ...
                            onBlur={form.handleBlur}
                            className={
                              ckeckInputHasError('expiresYear') ? 'error' : ''
                            }
                            mask={'99'}
                          />
                        </InputGroup>
                        <InputGroup maxWidth="46px">
                          ...
                          <InputMask
                            ...
                            onBlur={form.handleBlur}
                            className={
                              ckeckInputHasError('cardCode') ? 'error' : ''
                            }
                            mask={'999'}
                          />
                        </InputGroup>
                      ...
                      <Row marginTop="150px">
                        <InputGroup maxWidth="116px">
                          ...
                          <select
                            ...
                            onBlur={form.handleBlur}
                            className={
                              ckeckInputHasError('installments') ? 'error' : ''
                            }
                          >
